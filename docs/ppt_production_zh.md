...
| `resume` | 是 | 对 active review 执行 `approve`、`revise` 或 `cancel`；当前 review 可能是 `outline_review`、`deck_spec_review`、`page_preview_review` 或 `final_preview_review`。 |
