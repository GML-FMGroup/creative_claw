...
class OrchestratorTests(unittest.TestCase):
    def test_instruction_mentions_structured_final_response_contract(self) -> None:
        ...
        self.assertIn("build_mode\":\"multi_html", instruction)
        self.assertIn("design_settings.pages", instruction)
        self.assertIn("safe relative `.html` path", instruction)
        ...
        self.assertIn("text-layer PDF", instruction)
