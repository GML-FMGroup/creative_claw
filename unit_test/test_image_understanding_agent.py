...
from src.agents.experts.image_understanding.image_to_text_agent import ImageUnderstandingAgent
...
# --- Constants ---
APP_NAME = "image_understanding_test_app"
USER_ID = "test_user"
...
image_understanding_agent = ImageUnderstandingAgent(
    name="TestImageUnderstandingAgent",
)
...
async def call_agent_async(user_input: str):
    ...
    session_service, runner = await setup_session_and_runner(
        initial_state={"user_request": {"image_to_text_input_path":user_input}}
    )
