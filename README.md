...
- **PPT production tool**: `run_ppt_production` for durable PPT P0/P1 flows with optional brief review, outline review, page preview review, editable native `.pptx` generation, slide previews, quality report views, input recording, revision impact analysis, targeted outline/deck-slide revisions, page-level stale preview state, per-slide PPTX segments, stale slide preview/segment regeneration, and final artifact tracking.
...
- [docs/ppt_production_zh.md](docs/ppt_production_zh.md): PPT usage, optional brief review, outline/deck-spec review, native editable PPTX generation, previews, quality report, targeted revisions, fallback behavior, and P1 boundaries
