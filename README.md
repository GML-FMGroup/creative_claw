...
- **Production tool**: `run_short_video_production` for durable short-video P1d flows with storyboard review, asset-plan review, generated shot-segment review, targeted segment revision, partial segment regeneration, explicit provider/runtime selection, reference asset updates, and final artifact tracking.
...
- [docs/short_video_production_zh.md](docs/short_video_production_zh.md): short-video P1d usage, storyboard-first review, asset-plan review, shot review, targeted segment regeneration, Seedance 2.0/fast and Veo+TTS routing, and Feishu acceptance checklist
