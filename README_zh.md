...
- **生产工具**：`run_short_video_production`，用于短视频 P1a 的持久化生产流程，支持 storyboard 审阅、资产计划审阅、修改、参考素材更新和最终产物追踪。
...
- [docs/short_video_production_zh.md](docs/short_video_production_zh.md)：短视频生产 P1a 的 storyboard-first 运行方式、Seedance 2.0/fast 使用方式和飞书验收检查项
