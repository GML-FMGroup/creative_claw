...
- Current PPT production supports native editable PPTX generation, TXT/MD/DOCX source-document summaries, PPTX template summaries, outline review, deck spec review, generated slide previews, a quality report, status/view actions, and revision impact analysis. Template editing and PDF deep extraction remain future capabilities.
