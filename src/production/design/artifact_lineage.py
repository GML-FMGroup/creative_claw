    ...
    *,
    ...
    return {
        ...
        "report_counts": {
            ...
            "design_system_extraction": len(state.design_system_extraction_reports),
...
def _notes(
    *,
    ...
    if not report_refs.get("design_system_extraction_report_ids"):
        notes.append("No design-system extraction report is linked to this artifact.")
