"""ADK tool wrapper for Design production."""
...
async def run_design_production(
    ...
    """Run, inspect, resume, view, revise, or analyze an HTML-centered Design production task.
    ...
    Args:
        ...
        design_settings: Optional genre, audience, primary_action, and future design settings.
        user_response: User decision payload for resume, replacement details for add_reference_assets, or targets/notes for revision actions. Plain text is accepted and treated as revision notes.
    """
    if tool_context is None:
        return ProductionRunResult(
            ...
            progress_percent=0,
            message="tool_context is required for Design production.",
    ...
    if action == "start":
        ...
        result = ProductionRunResult(
            ...
            progress_percent=0,
            message=f"Unsupported Design production action: {action}",
        )
