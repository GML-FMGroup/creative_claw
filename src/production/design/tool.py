...
async def run_design_production(
    ...
    Args:
        ...
        view_type: Read-only view to load when action is view. Allowed values are overview, brief, design_system, design_system_extraction, components, accessibility, layout, preview, diagnostics, lineage, quality, events, and artifacts.
